...
PHQ_9 = st.number_input("📋 PHQ-9 (0 ==> 20)", min_value=0.0, max_value=20.0,step=1,help = "is a 9-item questionnaire used to assess the severity of depression in individuals.")
