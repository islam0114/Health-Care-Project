...
PHQ_9 = st.number_input("📋 PHQ-9 (0 ==> 20)", min_value=0.0, max_value=10.0,step=0.01,help = "is a 9-item questionnaire used to assess the severity of depression in individuals.")
