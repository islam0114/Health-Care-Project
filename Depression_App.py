...
PHQ_9 = st.number_input("📋 PHQ-9 (0 ==> 27) [to do PHQ-9 test: [Link](https://psychology-tools.com/test/phq-9)]", min_value=0.0, max_value=27.0,step=0.01,help = "is a 9-item questionnaire used to assess the severity of depression in individuals.")
